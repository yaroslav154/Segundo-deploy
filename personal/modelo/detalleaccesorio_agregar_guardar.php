    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                $id_accesorio = $_POST['id'];
                $detalle = strtoupper($_POST['detalle']);
                $sql_insert = "INSERT INTO detalleaccesorio (nronotarecepcion,idaccesorio,detalle)
                            VALUES ('$nronotarecepcion','$id_accesorio','$detalle')";
                $resultado = $mysqli->query($sql_insert);
                if ($resultado) {
                    //------------------BITACORA-------------------------------------
                    $accion = 'Agrego un accesorio en una nota de recepcion';
                ...
                <br>
                <br>
                <form action="../vista/detalleaccesorio.php" method="POST">
