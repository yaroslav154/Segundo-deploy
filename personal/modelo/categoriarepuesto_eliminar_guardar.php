...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h2>ELIMINAR CATEGORIA REPUESTO</h2>
                <?php
                include('../config/conexion.php');
                $id_categoriarepuesto = $_GET['id'];
                $sql = "DELETE  from `categoriarepuesto` WHERE id=$id_categoriarepuesto";
                $resultado = $mysqli->query($sql);


                if ($resultado) {
                    //------------------BITACORA-------------------------------------
                    $accion = 'Elimino una categoria de repuesto';
