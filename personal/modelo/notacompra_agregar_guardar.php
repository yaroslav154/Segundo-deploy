...
$sql_insert="INSERT INTO notacompra(id,nro,fecha,total,idproveedor,codpersonal)
       VALUES ('$id_nota','$numero','$fecha','$monto','$proveedor','$encargado')";
...
//------------------BITACORA-------------------------------------
$accion='Agrego una nota de compra'.':'.$id_nota;
