    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                $sql = "UPDATE detalleaccesorio SET detalle='$detalle' 
                WHERE idaccesorio  = '$id' and nronotarecepcion = $nronotarecepcion";
                $resultado = $mysqli->query($sql);
                if ($resultado) {
                    //------------------BITACORA-------------------------------------
                    $accion = 'Edito un accesorio en una nota de recepcion';
