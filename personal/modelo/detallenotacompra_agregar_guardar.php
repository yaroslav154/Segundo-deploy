...
$sql_insert= "INSERT INTO detallenotacompra(idnotacompra,codrepuesto,cantidad,preciounitario,subtotal) 
VALUES ( '$ID_nota', '$repuesto' ,'$cantidad', '$precio' , '$subtotal')";
...
//------------------BITACORA-------------------------------------
$accion='Agrego un detalle de nota compra'.":".$ID_nota;
