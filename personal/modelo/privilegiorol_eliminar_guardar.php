...
$Id_rol=$_GET['idrol'];
$Id_privilegio=$_GET['idprivilegio'];


$sql = "DELETE  from `privilegiorol`  WHERE `idrol`='$Id_rol' and `idprivilegio`='$Id_privilegio' ";
...
//------------------BITACORA-------------------------------------
$accion='Elimino un privilegio-rol';
