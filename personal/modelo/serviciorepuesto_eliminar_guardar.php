<?php include("../vista/cabeceracodigo.php"); ?>
			...
			<h2>ELIMINAR SERVICIO CON REPUESTO</h2>
...
$id_serviciorepuesto=$_GET['id']; 


$sql = "DELETE  from `serviciorepuesto`  WHERE `id`='$id_serviciorepuesto'";
...
//------------------BITACORA-------------------------------------
$accion='Elimino un serviciorepuesto';
