<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="">SALOEZ</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown"
                ...
                </svg> <?php echo $_SESSION['nombre_usu_lg']." ".$_SESSION['apellido_usu_lg'] ;?>
                <!-- <i class="fas fa-user fa-fw"></i> Font Awesome fontawesome.com -->
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="perfil.php">PERFIL </a></li>
                <li><a class="dropdown-item" href="Index2.php">Inicio</a></li>
                <li>
                    <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" <?php echo $_SESSION['nombre_usu_lg']." ".$_SESSION['apellido_usu_lg'] ;?>
                href="../modelo/cerrar_session.php">CERRAR SESION </a></li>
            </ul>
        </li>
    </ul>
</nav>