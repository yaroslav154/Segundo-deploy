        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $sql_select = "select repuesto.cod, repuesto.descripcion,repuesto.precio,categoriarepuesto.tiporepuesto,
                                        marca.nombremarca,categoriadispositivo.tipo
                        ...
                        while ($fila_usu = $resultado->fetch_assoc()) {
                            ...
                            $descripción = $fila_usu['descripcion'];
