...
<main>
                    <div class="container-fluid px-4">
                     ...
                     <?php $id_serviciorepuesto=$_GET['id']; ?>
							
                     <form action="../modelo/serviciorepuesto_editar_guardar.php" method="POST">	

 <input type="hidden" id="" name="id" VALUE="<?PHP  ECHO $id_serviciorepuesto; ?> "  required="required">
COSTO
