...
<main>
                    <div class="container-fluid px-4">
                     ...
                     <form action="../modelo/rolusuario_editar_guardar.php" method="POST">	
...
<select name="codusuario" required="required" class="form-control">
 <?php
   ...
   {
	  $id_usu=$fila['cod'];
	   $nombre1=$fila['nombreusuariol'];
       $nombrepersonal=$fila['nombrepersonal']
?>
<option value="<?php echo $id_usu; ?>"><?php echo  strtoupper($nombre1." ".$nombrepersonal); ?></OPTION>
<?php
   }
 ?>
 </select>
