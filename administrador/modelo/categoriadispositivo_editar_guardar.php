                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <h2>EDITAR CATEGORIA  DISPOSITIVO</h2>
                            ...
                            $sql = "UPDATE `categoriadispositivo` SET `tipo`='$nombre2' WHERE id=$Id_categoriadispositivo";
...
//------------------BITACORA-------------------------------------
$accion='Edito una categoria de dispositivo';
