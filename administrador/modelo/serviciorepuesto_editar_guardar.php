                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <h2> EDITAR SERVICIO CON REPUESTO </h2>
...
$sql = "UPDATE serviciorepuesto SET `id`='$id',`costo`= '$costo', `idcategoriaservicio`='$categoria_servicio', `codrepuesto` ='$codrepuesto', `idcategoriadispositivo`= '$categoria_dispositivo'
WHERE `id`= '$id'";
...
//------------------BITACORA-------------------------------------
$accion='Editó un nuevo Serviciorepuesto';
