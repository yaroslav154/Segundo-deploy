...
$sql = "UPDATE accesorio SET `nombre`='$nombre'
WHERE id=$ID_accesorio";
...
<br>
<br>				
	<a href="../vista/accesorios.php" class="btn btn-danger" class="button">VOLVER</a>				
  </div>
  <div>
