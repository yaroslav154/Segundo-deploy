...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <h1> TABLA DE NOTAS DE COMPRAS </h1>
    ...
    $nombrepersonal=$fila_usu['nombrepersonal'];
            ...
            <div>
                ...
                <a href="../controles/notacompra_agregar.php" class="btn btn-danger" class="button">AGREGAR</a>
                <a href="notacompra_botoneditar.php" class="btn btn-danger" class="button">EDITAR</a>
                <a href="notacompra_botoneliminar.php" class="btn btn-danger" class="button">ELIMINAR</a>
                <a href="detallenotacompra.php" class="btn btn-danger" class="button">AGREGAR DETALLE</a>
            </div>
        </div>
    </div>
</main>
