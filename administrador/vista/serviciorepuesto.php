    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql_select = "select serviciorepuesto.id,
                                    ...
                                    where serviciorepuesto.idcategoriaservicio=categoriaservicio.id and 
                                            serviciorepuesto.codrepuesto=repuesto.cod and 
                                            serviciorepuesto.idcategoriadispositivo=categoriadispositivo.id";
            ...
            <div>
                ...
                <a href="../controles/serviciorepuesto_agregar.php" class="btn btn-danger" class="button">AGREGAR</a>
                <a href="serviciorepuesto_botoneditar.php" class="btn btn-danger" class="button">EDITAR</a>
                <a href="serviciorepuesto_botoneliminar.php" class="btn btn-danger" class="button">ELIMINAR</a>
            </div>
        </div>
    </div>
</main>
