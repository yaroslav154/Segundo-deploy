    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <td> <a href='telefonocliente_botoneditar.php?id=<?php echo $idcliente; ?>' class="btn btn-primary" class="button"> EDITAR</a></td>
                <td> <a href='telefonocliente_botoneliminar.php?id=<?php echo $idcliente; ?>' class="btn btn-primary" class="button"> ELIMINAR</a></td>
            </div>
            <div>
