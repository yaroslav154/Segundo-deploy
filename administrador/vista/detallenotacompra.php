...
<main>
    ...
    $subtotal=$fila_usu['subtotal'];
            ...
            <div>
                ...
                <a href="../controles/detallenotacompra_agregar.php" class="btn btn-danger" class="button">AGREGAR</a>
                <a href="detallenotacompra_botoneditar.php" class="btn btn-danger" class="button">EDITAR</a>
                <a href="detallenotacompra_botoneliminar.php" class="btn btn-danger" class="button">ELIMINAR</a>
