...
<main>
	...
	$marca=$fila_usu['nombremarca'];
            ...
            <div>
                ...
                <a href="dispositivo_botoneditar.php" class="btn btn-danger" class="button">EDITAR</a>
                <a href="dispositivo_botoneliminar.php" class="btn btn-danger" class="button">ELIMINAR</a>
            </div>
        </div>
    </div>
</main>
